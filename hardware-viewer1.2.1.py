...
class Linux硬件驱动查看器:
    def __init__(self, 主窗口):
        ...
        # 当前主题模式（去掉跟随系统，默认浅色）
        self.当前模式 = tk.StringVar(value="浅色")
    ...
    def 创建标签页(self, 标签页名称, is_about=False):
        ...
        文本区域 = scrolledtext.ScrolledText(
            ...
            insertbackground=self.当前配色["标签页选中"],
            state=tk.DISABLED if is_about else tk.NORMAL
        )
        # 滚动条美化
        文本区域.vbar.configure(
            bg=self.当前配色["滚动条背景"],
    ...
    def 初始化关于页面(self):
        ...
        self.标签页["关于"].tag_add("title", "16.0", "17.0")# 开源致谢标题
        self.标签页["关于"].tag_add("title", "22.0", "23.0")# 开源协议标题
        self.标签页["关于"].tag_add("title", "25.0", "26.0")# 使用提示标题
